    ...
    <div className="navbar py-1">
      <div className="navbar-brand">
        <a className="navbar-item" href="/">
          <img
            src="https://cdn4.iconfinder.com/data/icons/healthy-life-line-live-long-and-prosper/512/Eat_healthy-512.png"
            alt="salad icon"
            className="image"
          />
      ...
      <div
        className={`navbar-menu navbar-start ${burgerOpen ? "is-active" : ""}`}
      >
        <NavLink exact activeClassName="active" to="/" className="navbar-item">
          Home
        </NavLink>

        <NavLink activeClassName="active" to="/recipes" className="navbar-item">
          My Favourites
        </NavLink>
